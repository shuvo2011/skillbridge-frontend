...
export function SessionBreakdownChart({ confirmed, completed, cancelled }: Props) {
	const data = [
	...
	return (
		<div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
			<h2 className="text-base font-semibold text-gray-800 mb-1">Session Breakdown</h2>
			<p className="text-xs text-gray-400 mb-4">Distribution of your sessions by status</p>
